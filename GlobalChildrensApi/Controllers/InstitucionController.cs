...
namespace GlobalChildrensApi.Controllers
{
    ...
    public class InstitucionController : ControllerBase
    {
        ...
        // Obtener instituci�n por ID (SOLICITADO)
        ...
        public async Task<ActionResult<Institucion>> GetByCodigo(string codigo)
        {
            try
            {
                ...
                if (institucion == null)
                {
                    ...
                    {
                        error = "INSTITUCION_NO_ENCONTRADA",
                        message = $"No existe una instituci�n con el c�digo '{codigo}'."
                    });
                }
        ...
        // Actualizar instituci�n (SOLICITADO)
        ...
        public async Task<IActionResult> UpdateInstitucion(long id, [FromBody] Institucion institucion)
        {
            try
            {
                ...
                if (existing == null)
                    ...
                    {
                        error = "INSTITUCION_NO_ENCONTRADA",
                        message = $"No existe una instituci�n con el id {id}."
                    });
            ...
            catch (DbUpdateException dbEx)
            {
                ...
                if (innerMessage.Contains("uq_codigo_institucion"))
                {
                    ...
                    {
                        error = "CODIGO_DUPLICADO",
                        message = $"Ya existe una instituci�n con el c�digo '{institucion.codigo}'.",
                        constraint = "uq_codigo_institucion"
                    });
                }
        ...
        // Inactivar instituci�n (SOLICITADO)
            ...
            try
            {
                ...
                if (institucion.estado == "INA")
                {
                    return BadRequest(new
                    {
                        ...
                        message = $"La instituci�n con id {id} ya est� inactiva."
                    });
                }

                // VALIDACI�N: Verificar si la instituci�n tiene sedes asociadas actualmente
                ...
                if (sedesAsociadas.Any())
                {
                    ...
                    return BadRequest(new
                    {
                        ...
                        message = $"No se puede inactivar la instituci�n porque tiene {sedesAsociadas.Count} sede(s) activa(s) asociada(s): {nombresSedes}. Debe inactivar las sedes primero.",
                ...
                return Ok(new
                {
                    message = "Instituci�n inactivada correctamente",
